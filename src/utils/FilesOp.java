...
public class FilesOp {
    ...
    public static File tryNewFile(String fileName) {
        ...
        try {
            if( fileName == null || fileName.isEmpty() ) {
                ...
                throw new FileOpenException(FilesOp.class.getName(), functionName, cause);
            }
    ...
    public static FileReader openFileReader(File file) {
        ...
        try {
            ...
            if( fileReaderToReturn == null ) {
                ...
                throw new FileReaderOpenException(FilesOp.class.getName(), functionName, cause);
            }
    ...
    public static FileWriter openFileWriter(File file, boolean doAppend) {
        ...
        try {
            ...
            if( fileWriterToReturn == null ) {
                ...
                throw new FileWriterOpenException(FilesOp.class.getName(), functionName, cause);
            }
    ...
    public static File renameFile( File currentFile, File newFile ) {
        ...
        try {
            if( utils.FilesOp.openExistingFile( currentFile.getAbsolutePath() ) == null )
                throw new RenameFileException(FilesOp.class.getName(), functionName, "parameter File currentFile doesn't exist");
            if( utils.FilesOp.openNewFile( newFile.getAbsolutePath()) == null )
    ...
    public static String renameFile( String currentFullFilePath, String newFullFilePath ) {
        File currentFile = utils.FilesOp.openExistingFile( currentFullFilePath );
        if( currentFile == null ) return null;
        File newFile = utils.FilesOp.openNewFile( newFullFilePath );
        if( newFile == null ) return null;
        newFile = utils.FilesOp.renameFile( currentFile, newFile );
        if( newFile == null ) {
            return null;
        }
        else {
