...
import utils.FileInHandlers;
import utils.FilesOp;
...
public class Exercise3 {
    ...
    {
        String functionName = "top_X_most_payed_employees(File f_employees)";
            ...
            while( buffer !=  null )
            {
                ...
                while( current_line.hasNext() )
                {
                    ...
                    if(column_counter == salary_nr)
                    {
                        ...
                        if( current_column.isEmpty() || !utils.ParseOp.isNumeric(current_column) ) {
